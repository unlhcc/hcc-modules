...
pushenv("CONDA_DEFAULT_ENV","prokka-1.13.4")
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/prokka/envs/prokka-1.13.4/bin",priority=100}
