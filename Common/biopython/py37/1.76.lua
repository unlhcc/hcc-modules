...
prepend_path{"PATH", "/util/opt/anaconda/deployed-conda-envs/packages/biopython/envs/biopython-1.76-py37/bin", priority=100}
pushenv("CONDA_DEFAULT_ENV","biopython-1.76-py37")
family("python")
