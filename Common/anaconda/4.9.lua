...
prepend_path("PATH", "/util/opt/anaconda/4.9.2/condabin")
prepend_path("PATH", "/util/opt/anaconda/4.9/condabin")
execute{cmd="source /util/opt/anaconda/4.9/etc/profile.d/conda."..myShellType()..">& /dev/null",modeA={"load"}}
...
if (mode() == "unload") then
  remove_path("PATH", "/util/opt/anaconda/4.9.2/condabin")
