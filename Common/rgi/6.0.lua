help (
[[
This module makes available RGI 6.0.2 (Resistance Gene Identifier).
...
pushenv("CARD_ANNOT", pathJoin(data, "card_database_v3.2.7.fasta"))
pushenv("CARD_WILD", pathJoin(data, "wildcard_database_v3.2.7.fasta"))
...
-- Fix the libopenssl library load in the bioconda rgi=6.0.2 setup --
