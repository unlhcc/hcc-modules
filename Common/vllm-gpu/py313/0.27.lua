...
pushenv("CONDA_DEFAULT_ENV", "vllm-gpu-0.27.0-py313")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/vllm-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/vllm-gpu/envs/vllm-gpu-0.27.0-py313/bin")
