...
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/bakta/envs/bakta-1.9.4/bin"}
pushenv("CONDA_DEFAULT_ENV"	,"bakta-1.9.4")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/bakta/envs")
setenv("BAKTA_DB", "/work/HCC/BCRF/app_specific/bakta/1.9.4")