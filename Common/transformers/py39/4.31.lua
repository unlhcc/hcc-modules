...
pushenv("CONDA_DEFAULT_ENV", "transformers-4.31.0-py39")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/transformers/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/transformers/envs/transformers-4.31.0-py39/bin")
