...
pushenv("CONDA_DEFAULT_ENV", "deepmd-kit-gpu-3.1.2-py312")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/deepmd-kit-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/deepmd-kit-gpu/envs/deepmd-kit-gpu-3.1.2-py312/bin")
setenv("LAMMPS_PLUGIN_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/deepmd-kit-gpu/envs/deepmd-kit-gpu-3.1.2-py312/lib/deepmd_lmp/")
