...
pushenv("CONDA_DEFAULT_ENV", "kraken2-2.17.1")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/kraken2/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/kraken2/envs/kraken2-2.17.1/bin")

setenv("KRAKEN2_STANDARD_DB","/work/HCC/BCRF/app_specific/kraken/2.17.1/k2_standard")
setenv("KRAKEN2_VIRAL_DB", "/work/HCC/BCRF/app_specific/kraken/2.17.1/k2_viral")
setenv("KRAKEN2_CORE_NT_DB", "/work/HCC/BCRF/app_specific/kraken/2.17.1/k2_core_nt")
setenv("KRAKEN2_PLUSPF_DB", "/work/HCC/BCRF/app_specific/kraken/2.17.1/k2_pluspf")
setenv("KRAKEN2_PLUSPFP_DB", "/work/HCC/BCRF/app_specific/kraken/2.17.1/k2_pluspfp")
