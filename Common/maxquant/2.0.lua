...
pushenv("CONDA_DEFAULT_ENV", "maxquant-2.0.3.0")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/maxquant/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/maxquant/envs/maxquant-2.0.3.0/bin")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/maxquant/envs/maxquant-2.0.3.0/lib/dotnet")

setenv("DOTNET_ADD_GLOBAL_TOOLS_TO_PATH","false")
setenv("DOTNET_TOOLS","/util/opt/anaconda/deployed-conda-envs/packages/maxquant/envs/maxquant-2.0.3.0/lib/dotnet/tools")
setenv("DOTNET_MULTILEVEL_LOOKUP","0")
setenv("DOTNET_SKIP_FIRST_TIME_EXPERIENCE","true")
setenv("DOTNET_ROOT","/util/opt/anaconda/deployed-conda-envs/packages/maxquant/envs/maxquant-2.0.3.0/lib/dotnet")
