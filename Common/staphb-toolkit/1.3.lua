...
pushenv("CONDA_DEFAULT_ENV", "staphb_toolkit-1.3.6")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/staphb-toolkit/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/staphb-toolkit/envs/staphb_toolkit-1.3.6/bin")
load("singularity")
load("nextflow")
