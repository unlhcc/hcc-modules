...
pushenv("CONDA_DEFAULT_ENV", "dm-sonnet-2.0.0-py39")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/dm-sonnet/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/dm-sonnet/envs/dm-sonnet-2.0.0-py39/bin")
