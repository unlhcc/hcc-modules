...
pushenv("CONDA_DEFAULT_ENV", "ffmpeg-4.3.1")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ffmpeg/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ffmpeg/envs/ffmpeg-4.3.1/bin")

setenv("FFMPEG", "/util/opt/anaconda/deployed-conda-envs/packages/ffmpeg/envs/ffmpeg-4.3.1")
