...
prepend_path("PATH",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-3.1.0/bin")
prepend_path("LD_LIBRARY_PATH",		"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-3.1.0/lib")
prepend_path("INCLUDE",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-3.1.0/include")
prepend_path("MANPATH",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-3.1.0/share/man")
pushenv("CONDA_DEFAULT_ENV",		"orthofinder-3.1.0")
