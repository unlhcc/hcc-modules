...
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/biopython/envs/biopython-1.70-py35/bin",priority=100}
pushenv("CONDA_DEFAULT_ENV","biopython-1.70-py35")
family("python")
