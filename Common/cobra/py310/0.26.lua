...
pushenv("CONDA_DEFAULT_ENV", "cobra-0.26.3-py310")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/cobra/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/cobra/envs/cobra-0.26.3-py310/bin")

-- gurobi
setenv("GUROBI_HOME", "/util/opt/anaconda/deployed-conda-envs/packages/cobra/envs/cobra-0.26.3-py310")
setenv("GUROBI_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/cobra/envs/cobra-0.26.3-py310")
setenv("GRB_LICENSE_FILE", "/util/opt/anaconda/deployed-conda-envs/packages/cobra/gurobi.lic")
setenv("LAZYLPSOLVERLIBS_GUROBI_LIB", "/util/opt/anaconda/deployed-conda-envs/packages/cobra/envs/cobra-0.26.3-py310/lib/libgurobi100.so")
