...
prepend_path{"PATH"		,"/util/opt/anaconda/deployed-conda-envs/packages/biom-format/envs/biom-format-2.1.6/bin",priority=100}
pushenv("CONDA_DEFAULT_ENV"	,"biom-format-2.1.6")
