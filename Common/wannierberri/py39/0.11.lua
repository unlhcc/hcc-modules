...
pushenv("CONDA_DEFAULT_ENV", "wannierberri-0.11.1-py39")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/wannierberri/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/wannierberri/envs/wannierberri-0.11.1-py39/bin")
