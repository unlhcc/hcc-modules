...
whatis("Description: Open Source next-generation build tool.")

pushenv("CONDA_DEFAULT_ENV", "scons-4.2.0")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/scons/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/scons/envs/scons-4.2.0/bin")
