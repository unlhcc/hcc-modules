...
prepend_path{"PATH"		,"/util/opt/anaconda/deployed-conda-envs/packages/fasttree/envs/fasttree-2.1.11/bin",priority=100}
pushenv("CONDA_DEFAULT_ENV"	,"fasttree-2.1.11")
