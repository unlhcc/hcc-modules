...
pushenv("CONDA_DEFAULT_ENV", "snakemake-9.26.1")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/snakemake/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/snakemake/envs/snakemake-9.26.1/bin")
