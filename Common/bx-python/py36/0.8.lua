...
pushenv("CONDA_DEFAULT_ENV", "bx-python-0.8.1-py36")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/bx-python/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/bx-python/envs/bx-python-0.8.1-py36/bin")
