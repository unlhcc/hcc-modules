...
load("singularity")
prepend_path("PERL5LIB", "/util/opt/anaconda/deployed-conda-envs/packages/cenote-taker2/envs/cenote-taker2-2020.04.01/lib/site_perl/5.26.2/")
setenv("CT2_DIR", "/work/HCC/BCRF/app_specific/cenote-taker2/2020.04.01/")

pushenv("CONDA_DEFAULT_ENV", "cenote-taker2-2020.04.01")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/cenote-taker2/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/cenote-taker2/envs/cenote-taker2-2020.04.01/bin")
