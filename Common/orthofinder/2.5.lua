...
prepend_path("PATH",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-2.5.5/bin")
prepend_path("LD_LIBRARY_PATH",		"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-2.5.5/lib")
prepend_path("INCLUDE",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-2.5.5/include")
prepend_path("MANPATH",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-2.5.5/share/man")
pushenv("CONDA_DEFAULT_ENV",		"orthofinder-2.5.5")
