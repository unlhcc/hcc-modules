...
pushenv("CONDA_DEFAULT_ENV", "mosdepth-0.3.8")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mosdepth/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mosdepth/envs/mosdepth-0.3.8/bin")
