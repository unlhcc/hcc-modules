...
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/theano/envs/theano-0.9.0-py27/bin")
prepend_path("LD_LIBRARY_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/theano/envs/theano-0.9.0-py27/lib")
prepend_path("LIBRARY_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/theano/envs/theano-0.9.0-py27/lib")
setenv("CUDA_ROOT", "/util/opt/anaconda/deployed-conda-envs/packages/theano/envs/theano-0.9.0-py27")
