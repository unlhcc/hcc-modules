...
load("mridata/1.0")
setenv("ASHS_ROOT", "/util/opt/anaconda/deployed-conda-envs/packages/ashs/envs/ashs-1.0.0")
setenv("ASHS_BIN", pathJoin(os.getenv("ASHS_ROOT"),"ext/Linux/bin"))

pushenv("CONDA_DEFAULT_ENV", "ashs-1.0.0")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ashs/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ashs/envs/ashs-1.0.0/bin")
