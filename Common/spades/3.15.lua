...
pushenv("CONDA_DEFAULT_ENV", "spades-3.15.2")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/spades/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/spades/envs/spades-3.15.2/bin")
