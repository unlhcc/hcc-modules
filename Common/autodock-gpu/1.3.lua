...
pushenv("CONDA_DEFAULT_ENV", "autodock-gpu-1.3")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/autodock-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/autodock-gpu/envs/autodock-gpu-1.3/bin")
...
if mode() == "load" then
  ...
  if jobid == "" then
    LmodMessage("\n**NOTE**: This module contains three versions of the autodock-gpu program, compiled with different CUDA work-group sizes:\n\tautodock_gpu_64wi\n\tautodock_gpu_128wi\n\tautodock_gpu_256wi\n")
