...
pushenv("CONDA_DEFAULT_ENV", "mumaxplus-1.0.0-py39")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mumaxplus/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mumaxplus/envs/mumaxplus-1.0.0-py39/bin")
