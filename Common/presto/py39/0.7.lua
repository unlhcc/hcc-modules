...
pushenv("CONDA_DEFAULT_ENV", "presto-0.7.9-py39")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/presto/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/presto/envs/presto-0.7.9-py39/bin")
