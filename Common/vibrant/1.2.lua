...
pushenv("CONDA_DEFAULT_ENV", "vibrant-1.2.1")
setenv("VIBRANT_DATA_PATH", "/work/HCC/BCRF/app_specific/vibrant/1.2.1/")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/vibrant/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/vibrant/envs/vibrant-1.2.1/bin")
