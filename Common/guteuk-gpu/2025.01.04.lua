help(
[[
This module loads Guteuk-gpu.
Version 2025.01.04
]]
)
whatis("Name: Guteuk-gpu")
...
pushenv("CONDA_DEFAULT_ENV", "guteuk-gpu-2025.01.04")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/guteuk-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/guteuk-gpu/envs/guteuk-gpu-2025.01.04/bin")
