...
-- prepend_path("PATH", "/util/opt/anaconda/23.7.0/condabin")
prepend_path("PATH", "/util/opt/anaconda/23.7/condabin")
execute{cmd="source /util/opt/anaconda/23.7/etc/profile.d/conda."..myShellType()..">& /dev/null",modeA={"load"}}
...
if (mode() == "unload") then
--  remove_path("PATH", "/util/opt/anaconda/23.7.0/condabin")
  remove_path("PATH", "/util/opt/anaconda/23.7/condabin")
end
