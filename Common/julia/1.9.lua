...
pushenv("CONDA_DEFAULT_ENV", "julia-1.9.2")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/julia/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/julia/envs/julia-1.9.2/bin")
prepend_path("LD_LIBRARY_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/julia/envs/julia-1.9.2/lib")
prepend_path("LIBRARY_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/julia/envs/julia-1.9.2/lib")

local home = os.getenv("HOME") or "/tmp"
setenv("JULIA_DEPOT_PATH", pathJoin(home,".julia"))
setenv("JULIA_PROJECT", pathJoin(home,".julia"))
setenv("JULIA_LOAD_PATH","@:@julia-1.9.2:@stdlib")
