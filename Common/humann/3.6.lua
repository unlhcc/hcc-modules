...
setenv("METAPHLAN_BOWTIE2_DB", "/work/HCC/BCRF/app_specific/metaphlan/4/vJan21_202103/mpa_vJan21_CHOCOPhlAnSGB_202103")
setenv("MPA_PKL", "/work/HCC/BCRF/app_specific/metaphlan/4/vJan21_202103/mpa_vJan21_CHOCOPhlAnSGB_202103.pkl")
pushenv("CONDA_DEFAULT_ENV", "humann-3.6")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/humann/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/humann/envs/humann-3.6/bin")
