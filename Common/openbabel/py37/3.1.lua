...
pushenv("CONDA_DEFAULT_ENV", "openbabel-3.1.1-py37")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/openbabel/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/openbabel/envs/openbabel-3.1.1-py37/bin")
