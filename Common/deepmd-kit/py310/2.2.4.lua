...
pushenv("CONDA_DEFAULT_ENV", "deepmd-kit-2.2.4-py310")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/deepmd-kit/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/deepmd-kit/envs/deepmd-kit-2.2.4-py310/bin")
