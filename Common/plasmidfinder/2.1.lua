...
pushenv("CONDA_DEFAULT_ENV", "plasmidfinder-2.1")
setenv("PLASMID_DB", "/work/HCC/BCRF/app_specific/plasmidfinder_db/2.1/")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/plasmidfinder/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/plasmidfinder/envs/plasmidfinder-2.1/bin")
