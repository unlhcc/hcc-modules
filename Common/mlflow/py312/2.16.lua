help(
[[
This module loads MLflow with Python 3.12.
Version 2.16.2
]]
)
...
pushenv("CONDA_DEFAULT_ENV", "mlflow-2.16.2-py312")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mlflow/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mlflow/envs/mlflow-2.16.2-py312/bin")
