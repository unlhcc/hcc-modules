...
pushenv("CONDA_DEFAULT_ENV","bbmap-39.06")
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/bbmap/envs/bbmap-39.06/bin/",priority=100}
