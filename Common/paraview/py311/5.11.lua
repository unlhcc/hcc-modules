...
pushenv("CONDA_DEFAULT_ENV", "paraview-5.11.1-py311")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/paraview/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/paraview/envs/paraview-5.11.1-py311/bin")
