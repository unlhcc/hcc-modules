...
pushenv("CONDA_DEFAULT_ENV", "pymatgen-2023.6.28-py39")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/pymatgen/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/pymatgen/envs/pymatgen-2023.6.28-py39/bin")
