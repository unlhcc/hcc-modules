help(
[[
This module loads psi4 with Python 3.11
Version 1.9.1
]]
)
...
pushenv("CONDA_DEFAULT_ENV", "psi4-1.9.1-py311")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/psi4/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/psi4/envs/psi4-1.9.1-py311/bin")
