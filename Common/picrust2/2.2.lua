...
pushenv("CONDA_DEFAULT_ENV", "picrust2-2.2.0_b")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/picrust2/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/picrust2/envs/picrust2-2.2.0_b/bin")
