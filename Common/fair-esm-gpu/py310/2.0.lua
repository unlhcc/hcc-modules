...
pushenv("CONDA_DEFAULT_ENV", "fair-esm-gpu-2.0.0-py310")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/fair-esm-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/fair-esm-gpu/envs/fair-esm-gpu-2.0.0-py310/bin")
