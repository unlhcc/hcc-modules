...
Note: This module includes tensorflow 2.13.
...
pushenv("CONDA_DEFAULT_ENV", "pytorch-2.0.0-py310")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/pytorch/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/pytorch/envs/pytorch-2.0.0-py310/bin")
