...
pushenv("CONDA_DEFAULT_ENV", "read2tree-0.1.5-py39")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/read2tree/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/read2tree/envs/read2tree-0.1.5-py39/bin")
