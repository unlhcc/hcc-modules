...
pushenv("CONDA_DEFAULT_ENV", "dedalus-2.1905-py37")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/dedalus/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/dedalus/envs/dedalus-2.1905-py37/bin")
