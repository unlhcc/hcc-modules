...
pushenv("CONDA_DEFAULT_ENV", "transformers-gpu-4.46.3-py311")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/transformers-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/transformers-gpu/envs/transformers-gpu-4.46.3-py311/bin")
