...
pushenv("CONDA_DEFAULT_ENV", "nextstrain-cli-3.0.3")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/nextstrain-cli/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/nextstrain-cli/envs/nextstrain-cli-3.0.3/bin")
