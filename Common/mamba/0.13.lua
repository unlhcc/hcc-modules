...
prepend_path("PATH", "/util/opt/mamba/0.13/condabin")
execute{cmd="source /util/opt/mamba/0.13/etc/profile.d/conda."..myShellType()..">& /dev/null",modeA={"load"}}
...
if (mode() == "unload") then
  remove_path("PATH", "/util/opt/mamba/0.13/condabin")
end
