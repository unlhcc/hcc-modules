...
pushenv("CONDA_DEFAULT_ENV", "prokka-1.13.7")
prepend_path{"PATH", "/util/opt/anaconda/deployed-conda-envs/packages/prokka/envs/prokka-1.13.7/bin", priority=100}
