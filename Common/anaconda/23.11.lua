...
-- prepend_path("PATH", "/util/opt/anaconda/23.11.0/condabin")
prepend_path("PATH", "/util/opt/anaconda/23.11/condabin")
execute{cmd="source /util/opt/anaconda/23.11/etc/profile.d/conda."..myShellType()..">& /dev/null",modeA={"load"}}
...
if (mode() == "unload") then
--  remove_path("PATH", "/util/opt/anaconda/23.11.0/condabin")
  remove_path("PATH", "/util/opt/anaconda/23.11/condabin")
end
