...
pushenv("CONDA_DEFAULT_ENV", "gurobi-8.1.0-py35")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/gurobi-python/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/gurobi-python/envs/gurobi-8.1.0-py35/bin")
setenv("GUROBI_HOME", "/util/opt/anaconda/deployed-conda-envs/packages/gurobi-python/envs/gurobi-8.1.0-py35")
setenv("GUROBI_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/gurobi-python/envs/gurobi-8.1.0-py35")
