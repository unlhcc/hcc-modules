...
pushenv("CONDA_DEFAULT_ENV","qiime2-2021.4")
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/qiime2/envs/qiime2-2021.4/bin",priority=100}
...
execute {cmd="source /util/opt/anaconda/deployed-conda-envs/packages/qiime2/envs/qiime2-2021.4/bin/tab-qiime",modeA={"load"}}
