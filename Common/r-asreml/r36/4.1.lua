help (
[[
This module loads r-ASReml with R 3.6.
Version 4.1.0.126
...
pushenv("CONDA_DEFAULT_ENV","r-asreml-4.1-r36")
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/r-asreml/envs/r-asreml-4.1-r36/bin",priority=100}
