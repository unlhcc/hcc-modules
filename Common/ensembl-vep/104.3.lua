...
pushenv("CONDA_DEFAULT_ENV", "ensembl-vep-104.3")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ensembl-vep/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ensembl-vep/envs/ensembl-vep-104.3/bin")
