...
pushenv("CONDA_DEFAULT_ENV", "cmake-3.14.5")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/cmake/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/cmake/envs/cmake-3.14.5/bin")
