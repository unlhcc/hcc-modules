...
pushenv("CONDA_DEFAULT_ENV","viennarna-2.7.0")
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/viennarna/envs/viennarna-2.7.0/bin",priority=100}
