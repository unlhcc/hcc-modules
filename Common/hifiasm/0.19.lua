...
pushenv("CONDA_DEFAULT_ENV", "hifiasm-0.19.8")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/hifiasm/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/hifiasm/envs/hifiasm-0.19.8/bin")
