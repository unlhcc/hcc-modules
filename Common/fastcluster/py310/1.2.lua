...
pushenv("CONDA_DEFAULT_ENV", "fastcluster-1.2.6-py310")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/fastcluster/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/fastcluster/envs/fastcluster-1.2.6-py310/bin")
