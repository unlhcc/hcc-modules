...
prepend_path("INCLUDE","/util/opt/anaconda/deployed-conda-envs/packages/opencv/envs/opencv-4.2.0-py38/include/opencv4")
prepend_path("CPATH","/util/opt/anaconda/deployed-conda-envs/packages/opencv/envs/opencv-4.2.0-py38/include/opencv4")
prepend_path("PKG_CONFIG_PATH","/util/opt/anaconda/deployed-conda-envs/packages/opencv/envs/opencv-4.2.0-py38/lib/pkgconfig")
setenv("OPENCV_DIR","/util/opt/anaconda/deployed-conda-envs/packages/opencv/envs/opencv-4.2.0-py38")
family("opencv")
