...
pushenv("CONDA_DEFAULT_ENV","spades-3.13.0-py35")
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/spades/envs/spades-3.13.0-py35/bin",priority=100}
