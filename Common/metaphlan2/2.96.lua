...
pushenv("CONDA_DEFAULT_ENV", "metaphlan2-2.96.1")
...
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/metaphlan2/envs/metaphlan2-2.96.1/bin")
