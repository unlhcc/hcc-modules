...
pushenv("CONDA_DEFAULT_ENV", "tassel-5.2.40")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/tassel/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/tassel/envs/tassel-5.2.40/bin")
