...
pushenv("CONDA_DEFAULT_ENV","bbmap-38.84")
prepend_path{"PATH","/util/opt/anaconda/deployed-conda-envs/packages/bbmap/envs/bbmap-38.84/bin/",priority=100}
