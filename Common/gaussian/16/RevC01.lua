...
if (found) then
   ...
   LmodError("You do not have permission to run Gaussian. This module is accessible only by UNK affiliates and to request access, please email hcc-support@unl.edu.")
end
