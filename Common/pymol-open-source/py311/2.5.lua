...
pushenv("CONDA_DEFAULT_ENV", "pymol-open-source-2.5.0-py311")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/pymol-open-source/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/pymol-open-source/envs/pymol-open-source-2.5.0-py311/bin")
