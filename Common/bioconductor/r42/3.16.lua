...
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/bioconductor/envs/bioconductor-3.16/bin")
pushenv("CONDA_DEFAULT_ENV", "bioconductor-3.16")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/bioconductor/envs")
prepend_path("R_LIBS", "/util/opt/anaconda/deployed-conda-envs/packages/bioconductor/envs/bioconductor-3.16/lib/R/library")
