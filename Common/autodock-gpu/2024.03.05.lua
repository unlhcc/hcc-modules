...
pushenv("CONDA_DEFAULT_ENV", "autodock-gpu-2024.03.05")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/autodock-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/autodock-gpu/envs/autodock-gpu-2024.03.05/bin")
