...
prepend_path{"PATH"		,"/util/opt/anaconda/deployed-conda-envs/packages/snp-pipeline/envs/snp-pipeline-1.0.1/bin",priority=100}
pushenv("CONDA_DEFAULT_ENV"	,"snp-pipeline-1.0.1")
pushenv("CLASSPATH",		"/util/opt/anaconda/deployed-conda-envs/packages/snp-pipeline/envs/snp-pipeline-1.0.1/share/varscan-2.4.3-0/VarScan.jar"
