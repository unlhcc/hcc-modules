...
pushenv("CONDA_DEFAULT_ENV", "dcm2niix-1.0.20230411")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/dcm2niix/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/dcm2niix/envs/dcm2niix-1.0.20230411/bin")
