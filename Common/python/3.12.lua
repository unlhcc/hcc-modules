...
pushenv("CONDA_DEFAULT_ENV", "python-3.12")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/python/envs")
prepend_path("PATH",                "/util/opt/anaconda/deployed-conda-envs/packages/python/envs/python-3.12/bin")
setenv("PYTHON_DIR", "/util/opt/anaconda/deployed-conda-envs/packages/python/envs/python-3.12")
