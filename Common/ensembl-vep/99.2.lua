...
prepend_path("PERL5LIB", "/util/opt/anaconda/deployed-conda-envs/packages/ensembl-vep/envs/ensembl-vep-99.2/lib/site_perl/5.26.2/")

pushenv("CONDA_DEFAULT_ENV", "ensembl-vep-99.2")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ensembl-vep/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ensembl-vep/envs/ensembl-vep-99.2/bin")
