...
pushenv("CONDA_DEFAULT_ENV", "awscli-1.23.6")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/awscli/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/awscli/envs/awscli-1.23.6/bin")
