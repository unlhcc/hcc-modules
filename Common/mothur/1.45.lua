...
pushenv("CONDA_DEFAULT_ENV", "mothur-1.45.3")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mothur/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mothur/envs/mothur-1.45.3/bin")
