...
pushenv("CONDA_DEFAULT_ENV", "anvio-6.2")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/anvio/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/anvio/envs/anvio-6.2/bin")
setenv("COG_DATA_DIR", "/work/HCC/BCRF/app_specific/anvio/6.2/COG")
