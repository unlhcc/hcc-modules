...
pushenv("CONDA_DEFAULT_ENV", "genometools-1.5.10-py36")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/genometools/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/genometools/envs/genometools-1.5.10-py36/bin")
