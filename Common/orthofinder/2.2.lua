...
prepend_path("PATH",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-2.2.6/bin")
prepend_path("LD_LIBRARY_PATH",		"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-2.2.6/lib")
prepend_path("INCLUDE",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-2.2.6/include")
prepend_path("MANPATH",			"/util/opt/anaconda/deployed-conda-envs/packages/orthofinder/envs/orthofinder-2.2.6/share/man")
