...
pushenv("CONDA_DEFAULT_ENV", "kraken2-2.1.3")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/kraken2/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/kraken2/envs/kraken2-2.1.3/bin")
setenv("KRAKEN2_DB","/work/HCC/BCRF/app_specific/kraken/2.1")
