...
prepend_path("PATH",                "/util/opt/anaconda/4.10/bin")
prepend_path("MANPATH",             "/util/opt/anaconda/4.10/share/man")
prepend_path{"PATH",                "/util/opt/anaconda/deployed-conda-envs/packages/python/envs/python-3.10/bin",priority=100}
setenv("PYTHON_DIR", "/util/opt/anaconda/deployed-conda-envs/packages/python/envs/python-3.10")
...
pushenv("CONDA_DEFAULT_ENV", "python-3.10")
family("python")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/python/envs")
