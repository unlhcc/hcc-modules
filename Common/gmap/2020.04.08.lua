...
pushenv("CONDA_DEFAULT_ENV", "gmap-2020.04.08")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/gmap/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/gmap/envs/gmap-2020.04.08/bin")
