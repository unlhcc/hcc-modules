...
pushenv("CONDA_DEFAULT_ENV", "gtdbtk-2.4.0")
setenv("GTDBTK_DATA_PATH", "/work/HCC/BCRF/app_specific/gtdbtk/release220/")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/gtdbtk/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/gtdbtk/envs/gtdbtk-2.4.0/bin")
